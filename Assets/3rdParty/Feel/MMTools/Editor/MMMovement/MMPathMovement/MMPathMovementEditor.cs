	...
	{		
		...
		protected virtual void OnSceneGUI()
	    {
			...
			for (int i=0;i<t.PathElements.Count;i++)
			{
				...
				var fmh_65_57_638231994780118567 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
